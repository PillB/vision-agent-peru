...
export function ModelSelector() {
  ...
  // If the active use case changed, compute new default selection
  const effectiveSelection = useMemo(() => {
    if (!activeUseCaseId) return new Set<string>()
    if (selectionState.useCaseId === activeUseCaseId) {
      return selectionState.modelIds
    }
