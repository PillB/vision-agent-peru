...
export const METRIC_PROVENANCE: MetricProvenance[] = [
  {
    ...
    definition: 'Total number of pinned YOLOS-tiny detections in the current frame (all returned classes)',
    ...
    source_line: '~425',
    transformations: [
      'Pinned YOLOS-tiny object-detection pipeline → predictions[]',
  ...
  },
  {
    ...
    definition: 'Time in milliseconds for the last pinned YOLOS-tiny inference',
    display_locations: ['camera-view.tsx (status bar)'],
    unit: 'milliseconds',
    ...
    transformations: [
      ...
      'predictions = await pinned YOLOS-tiny pipeline(RawImage.fromCanvas(canvas))',
  ...
  },
  {
    ...
    definition: 'Retired marketing claim: "30× faster than manual review" lacked a reproducible benchmark and is not displayed',
    display_locations: [],
    unit: 'ratio',
