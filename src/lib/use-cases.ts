...
export const USE_CASES: UseCase[] = [
  ...
  // ═══ Disaster Modes ═══
  {
    ...
    category: 'disaster',
    level: 'mldl',
    description: 'Vigilancia de inundación: CLIP zero-shot + detección de píxeles azules (agua). Sin segmentación de nivel.',
    descriptionEn: 'Flood watch: CLIP zero-shot + blue-pixel detection (water). No level segmentation.',
    detectionClasses: ['person'],
    primaryModel: 'CLIP zero-shot (Xenova/clip-vit-base-patch32)',
  ...
  },
  {
    ...
    category: 'disaster',
    level: 'mldl',
    description: 'CLIP zero-shot + frame-diff en ROI de ladera. Sin flujo óptico (pendiente).',
    descriptionEn: 'CLIP zero-shot + frame-diff on slope ROI. No optical flow (pending).',
    detectionClasses: ['person'],
    primaryModel: 'CLIP zero-shot (Xenova/clip-vit-base-patch32)',
  ...
  },
  {
    ...
    category: 'disaster',
    level: 'agentic',
    description: 'Post-sismo: CLIP zero-shot detecta grietas y daños estructurales. Verificación por píxeles oscuros (cracks). Severeidad ≥ 3 → INDECI.',
    descriptionEn: 'Post-seismic: CLIP zero-shot detects cracks and structural damage. Dark-pixel verification. Severity ≥ 3 → INDECI.',
    detectionClasses: ['person'],
    primaryModel: 'CLIP zero-shot (Xenova/clip-vit-base-patch32)',
