...
export const ALL_MODELS: ModelOption[] = [
  // ─── Person/Vehicle Detectors ───
  {
    ...
    notes: 'Selectable TF.js Lite MobileNet v2 adapter. The npm package is pinned; upstream graph assets remain remotely hosted and are reported as an operational supply-chain limitation.',
  ...
  },
  {
    ...
    notes: 'Selectable pinned Transformers.js object detector. Runs through the same WASM detection contract as YOLOS-tiny.',
    adapterImplemented: true,
  },
  {
    id: 'yolos-tiny',
    ...
    notes: 'Experimental Apache-licensed detector with an implemented WASM adapter and immutable model revision. Domain recall and speed remain unvalidated.',
    adapterImplemented: true,
  },
  ...
  // ─── Segmentation ───
  {
    ...
    notes: 'Pinned Transformers.js image-segmentation adapter; water-class masks are converted into a localized flood signal.',
    adapterImplemented: true,
  },
  ...
  // ─── Pose Estimation ───
  {
    ...
    revision: 'da4224085e2f6ce4c9ff9b670e28765194619db2',
    ...
    notes: 'Pinned low-level Transformers.js adapter using 17 keypoints, person-box aspect ratio, and torso verticality for localized fall candidates.',
    adapterImplemented: true,
  },
...
export const USE_CASE_MODELS: Record<string, string[]> = {
  intrusion:           ['coco-ssd', 'yolov10n', 'yolos-tiny'],
  after_hours:         ['coco-ssd', 'yolov10n', 'yolos-tiny'],
  crowd_surge:         ['coco-ssd', 'yolov10n', 'yolos-tiny'],
  parking:             ['coco-ssd', 'yolov10n', 'yolos-tiny'],
  queue_anomaly:       ['coco-ssd', 'yolov10n', 'yolos-tiny'],
  abandoned_object:    ['coco-ssd', 'yolov10n', 'yolos-tiny'],
  ...
  auto_report:         ['coco-ssd', 'yolov10n', 'yolos-tiny'],
...
export const DEFAULT_MODELS: Record<string, string> = {
  intrusion:           'yolos-tiny',
  after_hours:         'yolos-tiny',
  crowd_surge:         'yolos-tiny',
  parking:             'yolos-tiny',
  queue_anomaly:       'yolos-tiny',
  abandoned_object:    'yolos-tiny',
  graffiti:            'clip-zero-shot',
  fire_smoke:          'pixel-anomaly',
  slip_hazard:         'clip-zero-shot',
  incident_description: 'yolos-tiny',
  auto_report:         'yolos-tiny',
  visual_memory:       'yolos-tiny',
